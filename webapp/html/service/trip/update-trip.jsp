...
<section>
    ...
    <%@include file="../../components/sidebar-component.jsp" %>
        <main>
            <h1>Update Trip</h1>
            <hr>
            <form action="update-trip" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <input type="text" name="destination" value="${trip.destination}" class="form-control input-group" id="destination"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <input type="date" name="departureDate" value="${trip.departureDate}" class="form-control input-group" id="departureDate"
                               placeholder="0">
                        <small></small>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <input type="time" name="departureTime" value="${trip.departureTime}" class="form-control input-group" id="departureTime">
                        <small></small>
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <input type="text" name="driver" value="${trip.driver}" class="form-control input-group" id="driver"
                ...
                <div class="mb-1 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <input type="text" name="carType" value="${trip.carType}" class="form-control input-group" id="carType"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10 mt-3">
                        <input type="number" name="maximumTicketNumber" value="${trip.maxOnlineTickerNumber}" class="form-control input-group" id="maxTicketNumber"
                               placeholder="Enter maximum online ticket number">
                        <small></small>
                    </div>
                </div>

                <div class="mb-3 mx-5 pl-5 mt-5">
